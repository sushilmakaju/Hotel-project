...
public class CustomerManagement implements MouseListener {
	JFrame frame;
	JButton logoutbtn;
	...
	public CustomerManagement() {
		frame = new JFrame("CustomerManagement");
		...
		updatebtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JDBCRegistration jdbc = new JDBCRegistration();
				boolean result = jdbc.update(registration);
				if (result == true) {
					updateTable();
		...
		deletebtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JDBCRegistration res = new JDBCRegistration();
